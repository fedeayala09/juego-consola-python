...
def main():
    nombre_jugador = input("Bienvenido a la aventura. Ingrese tu nombre: ")
        ...
        while enemigo_actual.salud > 0:
            ...
            if accion == "atacar":
                ...
                if enemigo_actual.salud > 0:
                    ...
                    print(
                        f"El {enemigo_actual.nombre} te atacó y te causo {dano_enemigo} de daño"
                    )
...
if __name__ == "__main__": #nose asegura que solo podremos ejecutar este script desde el programa principal
    main()